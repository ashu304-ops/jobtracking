...
\begin{itemize}
    \item \textbf{C++:} Modern OOP, STL, RAII, Smart Pointers, C++17, FreeRTOS, STM32, Pointers, UART, SPI, I2C, Memory Management, Bare-Metal, Templates, Move Semantics, Concurrency
